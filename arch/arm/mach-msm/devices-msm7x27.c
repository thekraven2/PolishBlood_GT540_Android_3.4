...
struct clk_lookup msm_clocks_7x27[] = {
	...
	//	CLK_PCOM("ebi1_acpu_clk",	EBI_ACPU_CLK,	"ebi1_clk", NULL, 0),
	//	CLK_PCOM("ebi1_kgsl_clk",	EBI_KGSL_CLK,	"ebi1_clk", NULL, 0),
	//	CLK_PCOM("ebi1_lcdc_clk",	EBI_LCDC_CLK,	"ebi1_clk", NULL, 0),
	//	CLK_POCM("ebi1_mddi_clk",	EBI_MDDI_CLK,	"ebi1_clk", NULL, 0),
	//	CLK_PCOM("ebi1_usb_clk",	EBI_USB_CLK,	"ebi1_clk", NULL, 0),
	//	CLK_PCOM("ebi1_vfe_clk",	EBI_VFE_CLK,	"ebi1_clk", NULL, 0),
};
